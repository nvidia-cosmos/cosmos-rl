...
from cosmos_rl.dispatcher.data.packer.text_tokenizer import TextTokenizer
...
def get_text_tokenizer(tokenizer_local_path: str):
    tokenizer_config_dict = {
        "tokenizer_type": "deepseek_r1",
        "is_instruct_model": True,
        "tokenizer_local_path": tokenizer_local_path,
    }
    return TextTokenizer(**tokenizer_config_dict)


class DeepSeek_DataPacker(DataPacker):
    """
    ...
    def setup(self, config: Config, tokenizer: AutoTokenizer, *args, **kwargs):
        ...
        # FIXME - do we need the following line?
        self.tokenizer = get_text_tokenizer(config.policy.model_name_or_path)
