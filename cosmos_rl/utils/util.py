...
def compute_logprobs(
    ...
    # Shift token_ids
    logger.info(
        f"[Policy] Computing logprobs for {input_ids_batch.shape} input_ids and {logits.shape} logits"
    )
    ...
    if label_packing_mask is not None:
        ...
        logger.info(
            f"[Policy] Using label_packing_mask: {label_packing_mask.shape}, input_packing_mask: {input_packing_mask.shape}"
        )
