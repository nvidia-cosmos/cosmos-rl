...
COSMOS_HEARTBEAT_TIMEOUT = int(os.environ.get("COSMOS_HEARTBEAT_TIMEOUT", "2000"))
...
COSMOS_ROLLOUT_STEP_INTERVAL = int(os.environ.get("COSMOS_ROLLOUT_STEP_INTERVAL", "1"))
