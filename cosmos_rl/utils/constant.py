...
COSMOS_TEACHER_RESULT_GET_TIMEOUT = float(
    os.environ.get("COSMOS_TEACHER_RESULT_GET_TIMEOUT", "600.0")
)
COSMOS_TEACHER_RESULT_GET_TIMEOUT_INTERVAL = float(
    os.environ.get("COSMOS_TEACHER_RESULT_GET_TIMEOUT_INTERVAL", "0.01")
)
