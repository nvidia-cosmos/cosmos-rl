...
class HighAvailabilitylNccl:
    ...
    def __execute_build_mesh(self, cmd: BuildMeshCommand) -> bool:
        ...
        if rank == 0:
            ...
            self.api_client.setNcclCommInitiator(unique_pair_name, nccl_group_id)
            logger.debug(
            ...
            nccl_group_id = self.api_client.getNcclCommAcceptor(unique_pair_name)
        ...
        try:
            ...
            self.api_client.sendNcclCommError(self.replica_name, e)
            logger.error(
        ...
        if self.replica_name_to_rank.get(self.replica_name) == 0:
            self.api_client.clearNcclCommStore(unique_pair_name)
