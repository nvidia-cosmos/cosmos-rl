...
class CommMixin:
    ...
    def init_data_packer(self, metadata: Dict[str, Any]):
        from cosmos_rl.tools.dataset.dummy_sft import SFTRawTextDataset

        self.sft_user_dataset = SFTRawTextDataset()
        # self.sft_user_dataset.setup(self.config, self.tokenizer)
