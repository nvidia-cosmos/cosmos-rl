...
from cosmos_rl.policy.model.pi05.transformers_replace.configuration_siglip import SiglipConfig, SiglipTextConfig, SiglipVisionConfig
            ...
            torch.save(
                {
                    ...
                    "siglip.pooler_output": None if pooler_output is None else pooler_output.detach().cpu(),
                },
                p,
            )
