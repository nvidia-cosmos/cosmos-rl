...
class ProjectorConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        r"""
        This is the configuration class for projector. It is used to instantiate a stand-alone projector to align 
        visual model and language model.

        Args:
            input_hidden_size (`int`, default to 1024)
                Input size of the projector part, should be aligned with visual model
            use_postshuffle_norm (bool, default to False)
                Doing norm before or after shuffle
            spatial_merge_size (int, default to 2)
                Projector will do shuffle:
                    ((num_patch, input_hidden_size) -> 
                    (num_patch // spatial_merge_size **2, input_hidden_size * spatial_merge_size ** 2))
            merger_intermedia (int, default to 11520)
                The intermedia size between two linear layers
            out_hidden_size=1024
                The final output hidden size, should be aligned to language model's embedding size
        """
...
class NemotronSiglip2Config(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`NemotronHModel`]. It is used to instantiate a
    NemotronH model according to the specified arguments, defining the model architecture. Instantiating a configuration
    with the defaults will yield a similar configuration to that of the NemotronH-v0.1 model.
    ...
    sub_configs = {"vision_config": Siglip2VisionConfig, "projector_config": ProjectorConfig, "text_config": NemotronHConfig}
    keys_to_ignore_at_inference = ["past_key_values"]
...
__all__ = ["NemotronHConfig", "NemotronSiglip2Config"]