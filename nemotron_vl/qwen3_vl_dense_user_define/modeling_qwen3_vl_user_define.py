...
from .configuration_qwen3_vl_user_define import Qwen3VLConfig, Qwen3VLTextConfig, Qwen3VLVisionConfig
...
class Qwen3VLVisionPatchMerger(nn.Module):
    def __init__(self, config: Qwen3VLVisionConfig, use_postshuffle_norm=False) -> None:
        ...
        self.merger_intermedia = config.merger_intermedia
        self.use_postshuffle_norm = use_postshuffle_norm
        self.norm = nn.LayerNorm(self.hidden_size if use_postshuffle_norm else config.hidden_size, eps=1e-6)
        self.linear_fc1 = nn.Linear(self.hidden_size, self.merger_intermedia)
        self.act_fn = nn.GELU()
        self.linear_fc2 = nn.Linear(self.merger_intermedia, config.out_hidden_size)
