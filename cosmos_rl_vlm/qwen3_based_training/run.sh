...
COSMOS_HEARTBEAT_TIMEOUT=600 COSMOS_LOG_LEVEL=DEBUGG COSMOS_NCCL_TIMEOUT_MS=60000000 COSMOS_GLOO_TIMEOUT=60000 cosmos-rl --config ./qwen3_based_vlm.toml --port 8000 --rdzv-port 29345 ./launcher.py 