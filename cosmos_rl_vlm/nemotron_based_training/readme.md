...
Tips: lepton will auto bind /nfs to /workspace
...
```bash
cd cosmos_rl_vlm
cosmos-rl --config nemotron_based_training/nemotron_based_vlm.toml cosmos_vlm_launcher.py
```

This command:
1. Loads configuration from [nemotron_based_vlm.toml](cosmos_rl_vlm/nemotron_based_training/nemotron_based_vlm.toml)
2. Executes the launcher script at [launcher.py](cosmos_rl_vlm/cosmos_vlm_launcher.py)
